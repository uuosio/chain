...
func (db *IdxDB64) Lowerbound(secondary uint64) (SecondaryIterator, interface{}) {
	var primary uint64 = 0
...
func (db *IdxDB64) Upperbound(secondary uint64) (SecondaryIterator, interface{}) {
	var primary uint64 = 0
